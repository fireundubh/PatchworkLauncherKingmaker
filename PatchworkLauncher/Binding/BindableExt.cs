...
namespace Patchwork.Utility.Binding
{
	public static class BindableExt
	{
		...
		public static IBindable<TOut> Convert<TIn, TOut>(this IBindable<TIn> original, Func<TIn, TOut> convertOut = null, Func<TOut, TIn> convertIn = null)
		{
		...
		public static IBindable<TValue> Bind<TTarget, TValue>(this TTarget obj, Expression<Func<TTarget, TValue>> memberExpr, NotificationMode mode = null)
		{
