...
namespace Patchwork
{
	...
	public class NewMemberAttribute : MemberActionAttribute
	{
		...
		public NewMemberAttribute(string newMemberName = null) : this(false, newMemberName)
		{
		}
		...
		protected internal NewMemberAttribute(bool isImplicit, string newMemberName = null) : base(AdvancedModificationScope.NewlyCreated)
		{
