...
namespace Patchwork
{
	...
	public class MemberAliasAttribute : MemberActionAttribute
	{
		...
		public MemberAliasAttribute(string aliasedMemberName = null, object aliasedMemberDeclaringType = null, AliasCallMode callMode = AliasCallMode.NoChange) : base(ModificationScope.Nothing)
		{
